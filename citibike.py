...
plt.figure(figsize=(10, 10))
plt.scatter(lon, lat, c=hour_change.values(), s=size, cmap=plt.cm.Oranges)
plt.xlabel("Longitude")
plt.ylabel("Latitude")
plt.title("One hour CitiBike activity colored plot")
plt.colorbar(plt.scatter(lon, lat, c=hour_change.values(), s=size, cmap=plt.cm.Oranges))
